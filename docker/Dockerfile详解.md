...
### <span id="run">[RUN 执行构建](#menu)</span>
...
### <span id="env">[ENV 设置镜像环境变量](#menu)</span>
...
### <span id="copy">[COPY 复制文件](#menu)</span>
...
### <span id="add">[ADD 添加文件](#menu)</span>
...
### <span id="expose">[EXPOSE 暴露指定端口](#menu)</span>
...
### <span id="cmd">[CMD 设置镜像启动命令](#menu)</span>
...
### <span id="entrypoint">[ENTRYPOINT 设置接入点](#menu)</span>
...
### <span id="workdir">[WORKDIR 设置工作目录](#menu)</span>
...
### <span id="volume">[VOLUME 设置数据卷](#menu)</span>
